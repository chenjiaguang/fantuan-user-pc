...
(function() {
  ...
  Resizer.prototype = {
    ...
    updatePreview: function() {
      ...
      resizeElement(this.preview, box.width, box.height, false);
    },
    ...
    resizeComplete: function() {
      resizeElement(this.el, this.result.width, this.result.height,true);
    }
  };
  ...
  function resizeElement(el, width, height,complete) {
